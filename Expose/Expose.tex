...
\section{Zeitplan}
Für die geplante Arbeit ist ein Bearbeitungszeitraum von sechs Wochen vorgesehen. Innerhalb dieses Zeitraums erfolgt eine
vertiefende Literaturrecherche zu den drei Hauptkategorien. Die gewonnenen Erkenntnisse werden zusammengetragen,
analysiert und in die Arbeit integriert.

Die erste Woche dient einzig dieser intensiven Recherche. Schon vorhandene Quellen werden noch einmal in Detail
gesichtet und Informationen in Stichpunkten herausgearbeitet. Zusätzlich werden weitere Quellen, gerade Beispiele
zu Kratern mit Zentralbergen und dem Vulkanismus des Jupitermonds Io.

Die letzte der sechs Wochen ist ausschließlich der sprachlichen und inhaltlichen Überarbeitung vorbehalten.
Zu diesem Zweck wird der fortlaufend entstehende Text an Bekannte weitergegeben werden, die bereits langzeitige Erfahrungen
im Schreiben von Naturwissenschaftlichen Arbeiten und Expertise im Bereich der Geologie haben.

In den vier Wochen dazwischen wird die Arbeit auf Basis der vorher herausarbeiten Stichpunkte ausformuliert werden.
