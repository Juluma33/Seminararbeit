...
\renewcommand*{\bibfont}{\fontsize{11pt}{12pt}\selectfont}      % Größe der Verzeichnisses
...
mit einer Höhe von mehr als einem Meter \citep{peakvisor_mountains}, sowie nahezu 1.350 vermutlich aktive Vulkane \citep{usgs_volcanoes}.
Von diesen sind schätzungsweise 500 in historischen Zeiten nachweislich ausgebrochen \ebd[].
Die Bergbildung und der Vulkanismus auf der Erde sind allerdings Gegenstand zahlreicher Studien
und ihr Verständnis gilt als weitgehend etabliert \citep[77-104, 485-506]{Plummer_2015}.

Der italienische Gelehrte, Astronom und Philosoph Galileo Galilei berichtete 1610 in einer wissenschftlichen Arbeit 
erstmals über die Existenz von Bergen auf dem Mond und beschrieb damit als Erster Berge, Gebirge und Krater
auf einem anderen Himmelskörper \citep[13]{Galilei_1610}.
Die 1971 zum Mars gestartete Mariner 9 Sonde lieferte erstmals eindeutige Nachweise für Vulkanismus auf dem erdähnlichen Planeten \citep[]{McCauley_1972}.
Zudem wurden die von \citet[]{Peale_1979} formulierten Vorhersagen zur vulkanische Aktivität des Jupitermonds Io durch Beobachtungen
der Voyager 1 Sonde bestätigt \citep[]{Smith_1979}.
