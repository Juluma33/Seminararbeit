...
Die Prozesse der Orogenese (Bergbildung) und die Mechanismen des terrestrischen Vulkanismus auf der Erde sind allerdings bereits seit
langem Gegenstand intensiver Forschungen \citep[77-104, 485-506]{Plummer_2015}. Auf Grundlage umfangreicher geophysikalischer
und geochemischer Untersuchungen gilt daher heute das grundlegende Verständnis der zugrunde liegender Prozesse als weitgehend etabliert \ebd[].
...
erstmals in einer wissenschftlichen Arbeit die Existenz von Bergen auf dem Mond dokumentierte \citep[13]{Galilei_1610}. Damit beschrieb er als
...
Zusätzlich zu Vulkanen und Zentralbergen in Impaktkratern weist der Saturnmonde Iapetus 
...
\section{Gliederung}
Die geplante Seminararbeit wird thematisch in drei Hauptkathgorien aufeteilt sein: Zentralbergen in Impaktkratern, Vulkanismus und
Äquatorialkämmen. Die geschieht analog zum Themenabschnitt dieses Exposés. Diese Kategorien werden jeweils hinsichtlich ihrer
...
eine vergleichende Analyse zu Gemeinsamkeiten und Unterschieden dieser Kategorien durchgeführt werden.\\
...
beschrieben. Dafür sollen sowohl Daten aus Fernerkundung, sowie moderne Modelle zur Krater-, Vulkan- und Äquatorialkammbildung
verwendet werden, um ein umfassendes Bild über diese Prozesse zu liefern.\\
