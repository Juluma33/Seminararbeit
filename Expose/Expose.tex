...
\section{Gliederung}
%Die geplante Seminararbeit wird thematisch

Die vollendete Seminararbeit wird, analog zum Themenabschnitt dieses Exposés, in die drei ausgewählten Kategorien von Erhebungen im Sonnensystem
gegliedert. Diese Kategorien werden jeweils hinsichtlich ihrer Entstehungsprozesse, sowie ihrer charakteristische Merkmale systematisch
untersucht werden. Abschließend erfolgt eine vergleichende Analyse, die Gemeinsamkeiten und Unterschiede herausarbeitet und diese auf
die Entstehung der Strukturen bezieht.
