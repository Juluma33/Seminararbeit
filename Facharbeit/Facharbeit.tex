...
der nördliche Kraterboden auf $\sim$1080m (siehe Abb.\ref{pic:tooting})\citep[1]{Mouginis-Mark_2015}.
...
Dazu gehören ein Verlangsamen der Rotationsgeschwindigkeit von 17~h hin zu einer heutigen
gebundenen Rotation (siehe Kapitel \ref{subsubsec:Verlangsamen der Rotationsgeschwindigkeit des Iapetus})
...
\begin{center}[Maybe noch Übergang zu \ref{subsubsec:Impaktbedingte Entstehung des Äquatorialkamms} über Inklinationsauffälligkeit\\
und größe des grav einflussbereichs als arg für theorie]\end{center}
...
sondern auch auf der Venus und dem Jupitermond Io \citep[687]{Sigurdsson_2015}.

Auch auf dem Mars hat Vulkanismus existiert, der allerdings bereits erloschen ist \ebd[].
Dennoch existieren die größten bekannten Vulkane des Sonnensystem auf diesem Himmelskörper,
wie beispielsweise der 25~km hohe Olympus Mons \ebd[].

Die dunkle Färbung der Tiefebenen unseres Mondes, der sogenannten Mare (lateinisch \glqq Meer\grqq),
resultiert daher, dass sie aus abgekühlter basaltischer Lava bestehen \ebd[].
...
An den Orten im äußeren Erdmantel an dem sich Hitze anstaut schmilzt das Gestein mit der geringsten
...
Vulkane, die sich bis zu 9km über den Meeresboden erstrecken \citep{Fraknoi_2022}.

\begin{center}
    [Übergang \ref{subsec:Basaltebenen auf Mond und Merkur} mit \citet{Fraknoi_2022}]
\end{center}
