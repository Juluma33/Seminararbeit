...
Ein anschauliches Beispiel für einen Krater mit Zentralberg ist der Tothing-Krater. Der auf dem Mars, in der Amazonis Planitia,
...
der nördliche Kraterboden auf $\sim$1080mm (siehe Abb.\ref{P_Toothing})\citep[1]{Mouginis-Mark_2015}.

Der Zentralberg des Toothing-Kraters liegt 119m unterthalb der Kraterumgebung und 768m unterhalb der durschnittlichen Randkamms des Kraters \ebd[].
Der Toothing-Krater zeichnet sich durch mehrere sekundäre Bergspitzen aus. Die zentrale Spitze erreicht eine Höhe von 1110m über dem Kraterboden \ebd[],
...
\begin{center}
    \begin{figure}[h]
        ...
        \includegraphics[width=0.45\textwidth]{../Quellen/Bilder/Toothing.png}
        \caption{Links: Topografisches Profil des Tooting-Krater, das durch den höchsten Punkt des Zentralbergs verläuft. Die vertikale Maßstabsverzerrung beträgt ×10. Entnommen aus \citet[1619]{Mouginis-Mark_2012}.\\
                Rechts: Der Toothing-Krater aus Aufnahmen der NASA am 29.08.2026 (\url{https://themis.mars.asu.edu/files/features/043_tooting_crater/043tooting.png})}
        \label{P_Toothing}
    \end{figure}
\end{center}
...
Diese ringförmigen Reliefs finden sich 
