...
Die Oberflächen von Himmelskörpern werden durch eine Vielzahl geologischer Prozesse geprägt.
Neben Einschlägen von Asteroiden können auch vulkanische und tektonische Prozesse großräumige Oberflächenstrukturen erzeugen.
Dabei unterscheiden diese sich teilweise von Strukturen auf der Erde, während sich Andere trotz verschiedener physikalischer
Bedingungen auf verschiedenen Himmelskörpern wiederfinden. 

In dieser Arbeit werden ausgewählte geologische Strukturen
und die Prozesse ihrer Entstehung in unserem Sonnensystem untersucht und verglichen.
Dazu gehören Zentralberge und Zentralringe in Impaktkratern, der ungewöhnliche Äquatorialkamm des Saturnmondes Iapetus
und unterschiedliche Ausprägungen vulkanischer Aktivität auf unterschiedlichsten Himmelskörpern.

Die zunehmende Erforschung extraterrestrischer Himmelskörper, insbesondere durch Raumsonden, hat in den
vergangenen Jahrzehnten zu einem starken Zuwachs an Erkenntnissen über geologische Prozesse auf anderen
Himmelskörpern geführt.
Daher soll diese Arbeit anhand geeigneter Fallbeispiele einen vergleichenden Überblick über die Entstehung
und Form geologischer Oberflächenstrukturen im Sonnensystem zu geben.
...
einen $\sim$1100~m hohen Zentralberg \parencite[1615, 1616, 1619]{Mouginis-Mark_2012}.
Das umliegende Terrain und das juge Alter des Kraters, macht exakte Tiefenmessungen möglich \parencite[1616]{Mouginis-Mark_2012}.
so liegt der Kraterboden der südlichen Kraterhälfte $~\sim$1275~m unter dem umliegenden Terrain und
der nördliche Kraterboden auf $\sim$1080~m (siehe Abb.\ref{pic:tooting})\parencite[1]{Mouginis-Mark_2015}.

Der Zentralberg des Tooting-Kraters liegt 119~m unterhalb der Kraterumgebung und
768~m unterhalb der durschnittlichen Randkamms des Kraters \parencite[1]{Mouginis-Mark_2015}.
Der Tooting-Krater zeichnet sich durch mehrere sekundäre Bergspitzen aus.
Die zentrale Spitze erreicht eine Höhe von 1110~m über dem Kraterboden \parencite[1]{Mouginis-Mark_2015},
Die Sekundären Spitzen 149 und 147~m unterhalb dieser \parencite[1619]{Mouginis-Mark_2012}.
...
\begin{center}
    \begin{figure}
        ...
        \caption{Links: Topografisches Profil des Tooting-Krater, das durch den höchsten Punkt des
                Zentralbergs verläuft. \citep[1619]{Mouginis-Mark_2012}.\\[0.2cm]
                Rechts: Foto des Tooting-Kraters. Ausschnitt von der Aufnahme der THEMIS-Mission der NASA. \citep{pic:Tooting}.}
        \label{pic:tooting}
    \end{figure}
\end{center}
...
Bei größeren Kratern entsteht eine zentrale Erhebungen durch sich hebendes Gestein \parencite[10]{Rae_2018}.
Solche Krater werden als komplexe Krater bezeichnet und besitzen abgesehen von Zentralbergen oder Zentralringen
häufig auch weitläufige terrassenförmige Zonen am Kraterrand, die hier nicht weiter behandelt werden sollen \parencite[10]{Rae_2018}.
...
abhängig von vorhandenen Gesteinsarten \parencite[12]{Rae_2018}.
...
kollabiert zu einem Zentralring \parencite[115]{Rae_2018}.
...
einen 400~m hohen Zentralring \parencite[100]{Rae_2018}. Der $\sim$65,5 Millionen Jahre alte Krater entstand durch
den Asteroiden, welcher das Massenaussterbens am Ende der Kreidezeit verursachte und
unter Anderem zum Aussterben der Dinosaurier führte \parencite[1214]{Schulte_2010}.

Der instabile Zentralberg hat nach Berechnungen seine maximale Höhe nach $\sim$200~s erreicht und
kollabierte dann zu dem heutigen Zentralring mit 80-90~km Durchmesser \parencite[100, 113]{Rae_2018}.
Dessen Gestein findet sich nur zwischen 30 und 45~km entfernt von der Kratermitte \parencite[113]{Rae_2018}.
...
von mehr als 2~km \parencite[102 f.]{Rae_2018}.
...
des Mondes zu sehen \parencite[1237]{Porco_2005}.
Dieser bis zu 20~km hohe Äquatorialring erstreckt sich über
mindestens 75\% des Umfangs von Iapetus \parencites[2262]{Dombard_2008}[1241]{Porco_2005}.

Der Gebirgsring ist zusammen mit der Cassini-Region, einer im Vergleich zu Iapetus restlicher Oberfläche
etwa um den Faktor zehn dunklere Region,
eines der ältesten Merkmale des Iapetus \parencites[361]{Giese_2008}[1241]{Porco_2005}.
Da er in manchen Regionen aus drei parallel verlaufenden Berggraten besteht \parencite[1242]{Porco_2005},
...
\begin{center}
    \begin{figure}
        ...
        \caption{Aufnahmen der Saturnmondes Iapetus. Der Bergkamm ist deutlich am Äquator erkennbar. \citep[1240]{Porco_2005}.}
        \label{pic:iapetus}
    \end{figure}
\end{center}
...
durch ein Verlangsamen der Rotationsgeschwindigkeit des Iapetus aufgebracht \parencite[1242]{Porco_2005}.
Begründet wurde dies durch seine äquatoriale Position \parencite[1242]{Porco_2005}.

Bei genauerer Betrachtung weißt der Iapetus eine Äquatoriale Ausbeulung vor \parencite[182]{Castillo-Rogez_2007}.
...
von durchschnittlich $\sim$10~m zwischen diesen beiden Durchmessern geben \parencite[580]{Thomas_2007}.
Die gemessene 35~km-Differenz ist in Iapetus Fall durch die Zentrifugalkraft bei einer Rotationsdauer
von $\sim$16~h zu erklären \parencite[580]{Thomas_2007}. Jedoch besitzt der Iapetus heute eine
Rotationsdauer von 79,33 Tagen \parencite[180]{Castillo-Rogez_2007}.

Die Form des Mondes und sein Äquatorialkamm ist nach dieser Theorie durch eine hohe Rotationsgeschwindigkeit 
entstanden \parencite[182]{Castillo-Rogez_2007}. Damit diese durch Zentrifugalkraft stabil gehaltene Form nicht aufgrund der Verlangsamung
der Rotationsgeschwindigkeit zusammenfällt, muss die vorher dünne Lithosphäre dick genug werden um stabil genug 
zu werden um die Form des Iapetus aufrecht zu erhalten \parencite[198]{Castillo-Rogez_2007}.
...
Wobei dieses Abbremsen nicht-linearer sein darf, um diesen Prozess zu erklären \parencite[198]{Castillo-Rogez_2007}.
...
Diese basiert auf den Funden von natürlichen Satelliten, die größere Objekte im Kuipergürtel umkreisen \parencite[4]{Ip_2006}.
...
zum heutigen Äquatorialkamm anhäufen konnten \parencite[3]{Ip_2006}. Das ursprüngliche System müsste eine
Masse von $\sim$0,1\% von der des Iapetus besitzen \parencite[3]{Ip_2006}.
...
in dem seine Anziehungskraft gegenüber anderen Körpern überwiegt \parencite[2]{Ip_2006}.
...
dass der Iapetus zu der Zeit eine dünnen Atmosphäre besaß, welche die Objekte durch Reibung abbremst \parencite[3]{Ip_2006}.

Alle anderen Monde des Saturn besitzen eine Inklination, also Bahnneigung, von $\sim$0\degree \parencite[4]{Ip_2006}.
Die Inklination des Iapetus liegt währenddessen bei $\sim$7,49\degree \parencite[180]{Castillo-Rogez_2007}.
\citeauthor{Ip_2006} bringt die Möglichkeit einer Kollision mit einem anderen Himmelskörper als Hintergrund
der Inklinationsanomalie und des Ringsystems auf \parencite[4]{Ip_2006}. Demnach ist der Ring nicht wie in seiner Theorie
ein Überrest der Entstehung des Iapetus sondern impaktgeneriert. Diese Beobachtung führe zur weiteren Untersuchung
...
So besitzt der Äquatorialkamm eine komplexe, sich über seine Länge ändernde Form \parencite[365]{Giese_2008}.
Die an einigen Stellen vorkommenden flachen Bergspitzen mit scharfen Kanten an ihren Seiten sind
nicht durch die Theorie eines Ringsystems erklärbar (siehe Kapitel \ref{subsubsec:Ein uraltes Ringsystem}) \parencite[365]{Giese_2008}.
Auch sprechen Ausgedehnte parallel zum Kamm verlaufende Senken für ein verbiegen der Lithosphäre \parencite[364]{Giese_2008}.

Des Weiteren wäre bei einem aus kleinen Ringbestandteilen bestehendem Kamm eine Steigung
nahe der maximalen Steigung, wo ein solcher Berghang stabil bleiben würde, zu erwarten \parencite[364]{Giese_2008}.
Dies ist gerade bei den unteren Hängen nicht der Fall und die geringe Steigung spricht eher 
für einen intrinsischen Mechanismus \parencite[364]{Giese_2008}.

Am wahrscheinlichsten ist ein zwei-Zellen-Konvektionsmuster, welches tiefliegendes Gestein Richtung
Oberfläche schiebt und die Lithosphäre zu einem äquatoriellen Bergsystem aufwölbt \parencite[64, 65, 68]{Czechowski_2008}.
Angetrieben wird dieser Mechanismus von Abwärme durch radioaktiven Zerfall im Inneren des Iapetus \parencite[64]{Czechowski_2008}.
...
Aufbauend auf dem von \citeauthor{Ip_2006} (siehe Kapitel \ref{subsubsec:Ein uraltes Ringsystem})
vorgeschlagenen Modell wurde die heute als die Wahrscheinlichste geltende Hypothese zur Entstehung des
Äquatorialkamms entwickelt. Demnach entstand der Kamm aus einem Ringsystem,
das sich durch des Zerbrechens eines ehemaligen Satelliten des Iapetus bildete \parencite[143]{Damptz_2018}.

Nach dieser Theorie besaß der Iapetus einen Subsatelliten, das heißt einen ihn umkreisenden, kleineren
Himmelskörper, welcher durch Wechselwirkung der Gezeitenkräfte mit dem Iapetus ausgebremst wurde \parencite[5]{Dombard_2012}.
Durch das Abbremsen eines Himmelskörpers auf seiner Bahn wird diese Bahn kleiner, weshalb der Subsatellit
die Roche-Grenze, also die minimale Entfernung, die ein Himmelskörper zu einem Anderen haben kann, ohne zu auseinanderzubrechen,
des Iapetus unterschreitet \parencite[6]{Dombard_2012}. 
Der entstehende Ring aus Bruchstücken fällt nun, wie im Szenario von \citeauthor{Ip_2006}
(siehe Kapitel \ref{subsubsec:Ein uraltes Ringsystem}) auf die Oberfläche des Iapetus und
bildet den Äquatorialkamm \parencite[6]{Dombard_2012}.

Die Autoren der Theorie schlagen zwei Möglichkeiten vor, woher der Subsatellit stammen könnte.
Die Erste ist ein großer Einschlag in der Frühzeit des Iapetus, aus dessen Trümmerscheibe sich der
Subsatellit bildete \parencite[5]{Dombard_2012}.
Die Zweite ist ein Einfangen eines anderen Satelliten des Saturn \parencite[5]{Dombard_2012}.
Möglich wäre dies aufgrund der geringen Geschwindigkeitsänderung, die hierfür nötig wäre \parencite[5]{Dombard_2012}.

Durch die Äquatoriale Position des Ringsystems kann so erklärt werden, warum der Kamm genau und nur auf dem
Äquator liegt \parencite[6]{Dombard_2012}. Auch das seltene Vorkommen eines solchen Kamms kann durch die
große Entfernung des Iapetus zum Saturn erklärt werden, da so der Subsatellit längere Zeit auf einer Bahn
um den Iapetus verbringen konnte, ohne in eine Umlaufbahn um den Saturn zu geraten \parencite[6]{Dombard_2012}.
...
(siehe Kapitel\ref{subsec:Vulkanismus auf dem Io}) \parencite[687]{Sigurdsson_2015}.
Auf dem Mars existieren die höchsten Vulkane des Sonnensystems, wie der Olympus Mons
(siehe Kapitel \ref{subsec:Vulkanismus auf dem Mars}) \parencite[687]{Sigurdsson_2015},
...
(siehe Kapitel \ref{subsec:Basaltebenen auf Mond und Merkur}) \parencite[687]{Sigurdsson_2015}.
...
Schmelztemperatur und sammelt sich in größeren Reservoir \parencite{USGS_Volcanism}.
Überdruck in diesen Kammern drückt das geschmolzene Gestein, Magma genannt, durch strukturell
schwache Zonen und Risse im Gestein bis an die Oberfläche \parencite{USGS_Volcanism}.
...
dem Gestein geschehen \parencite{USGS_Volcanism}.

Der Vulkan selbst bildet sich aus diesem sich nach und nach anhäufendem Gestein \parencite{USGS_Volcanism}.
Die Inselkette Hawaii ist beispielsweise vulkanischen Ursprungs und beherbergt
Vulkane, die sich bis zu 9~km über den Meeresboden erstrecken \parencite{Fraknoi_2022}.
...
Gravitation die Voraussetzungen für lange anhaltenden Vulkanismus \parencite[67]{Ivanov_2013}.
...
Oberfläche sehr trocken sind \parencite[606]{Smrekar_2010}.
Hierdurch sind auch für den Vulkanismus vollständig andere Bedingungen gegeben.

Rund 80\% der venusischen Oberfläche bestehen aus vulkanischem Material \parencite[67]{Ivanov_2013}.
Dies liegt an einer globalen Oberflächenerneuerung, einem starken vulkanischen Event, bei dem innerhalb
der letzten 100 Millionen Jahre fast die gesamte Oberfläche der Venus erneuert wurde \parencite[42]{Nimmo_1998}.
Ob es sich um ein kurzes Extremereignis oder einen langen Prozess handelte ist unbekannt \parencite[40]{Nimmo_1998}.
Bekannt ist, dass die geologische Aktivität der Venus seitdem zurückgegangen ist \parencite[40]{Nimmo_1998}.

Vulkanische Ebenen sind die weiterbreitetsten vulkanischen Strukturen auf der Venus \parencite[68]{Ivanov_2013}.
Auch Schildvulkane sind bekannt, die im Vergleich zur Erde deutlich größer und mit einer Hangsteigung von
<3\degree auch flacher sind \parencite[2]{Mason_2025}.
Der Ozza Mons zeigt genau diese geringe Steigung. Er ist mit 7,5~km ein mittelhoher Vulkan der Venus, aber
1000~x~800~km breit \parencite[12]{Mason_2025}.
Der Maat Mons ist der doppelten Höhe des Ozza Mons der höchste Vulkan der Venus, allerdings weniger breit \parencite[13]{Mason_2025}.

Der Grund für das große Ausmaß der Schildvulkane ist die Abwesenheit von starker Plattentektonik,
wie der auf der Erde \parencite[2f.]{Mason_2025}.
Durch die weniger dichte Lithosphäre wird Subduction, also ein Abtauchen von Teilen der Lithosphäre unter
Anderen Teilen, verhindert und die Lithosphäre ist weniger Mobil \parencite[40]{Nimmo_1998}.
...
Die Venus gilt auch aktuell noch als vulkanisch aktiver Himmelskörper \parencite[607]{Smrekar_2010}.
Durch Aufnahmen im Infrarotbereich durch die Venus Express Sonde konnten verschiedene Bereiche mit hoher
Emission von Infrarotstrahlung indentifiziert werden \parencite[605, 606]{Smrekar_2010}.
Da einige dieser Orte Vulkane, wie der Idunn Mons oder Hathor Mons sind \parencite[606]{Smrekar_2010}, ist eine rezente vulkanische
Aktivität auf der Venus sehr wahrscheinlich. Auch zeigt ein relativ junker Gesteinsstrom in der Themis Region
hohe Emissionsraten, was diese Annahme weiter untermauert \parencite[606]{Smrekar_2010}.
...
\begin{center}
    [ coronae (ivanov,mason) Radionuklide!!!]
\end{center}
...
Abseits der Erde ist der Jupitermond Io der wohl interessanteste und
vulkanisch aktivste Himmelskörper \parencite[1]{Prajan_2025}.
Er ist der innerste der von Galileo Galilei entdeckten Galileischen Monde
und der drittgrößte Aller Jupitermond \parencite[1]{Prajan_2025}.

Der Vulkanismus des Ios äußert sich durch den Ausstoß mehrerer hundert Kilometer hoher
Gas- und Staubwolken \parencite[505, 509, 517]{Geissler_2008}.
Diese Wolken sind aufgrund der etwa 80-120~nm großen Partikel meist blau (siehe Abb. \ref{pic:Io}) oder
gelb bei größeren Partikeln \parencite[513, 514]{Geissler_2008}.


Diese Ausstöße von Gas und Staub werden auf dem Io in zwei Klassen unterteilt. Die größeren Ausstöße von Peele-Typ,
benannt nach dem Io-Vulkan Peele, besitzen eine eher homogene Dichteverteilung der Staubpartikel \parencite[507]{Geissler_2008}.
Die häufiger vorkommenden Ausstöße vom Prometheus-Typ sind kleiner und besitzen eine zentrale Staubsäule in der
Mitte der diffusen Wolke \parencite[506, 507]{Geissler_2008}.
Die Entstehung der Prometheus-Typ Ausstöße liegt, im Vergleich zu den aus Vulkanen stammenden Ausstoßungen der Peele-Typ Ausstöße,
vermutlich an Magmaströmen auf der Oberfläche des Io, welche flüchtige Stoffe verdampfen lassen \parencite[240]{Spencer_2007}.

Die nötige Energie zum Aufrechterhalten des Vulkanismus erlangt der Io durch Wechselwirkung der Gezeitenkräfte
mit den anderen Monden Ganymed und Europa \parencite[1]{Kleer_2024}.
Die drei inneren Galileischen Monde stehen in einer Bahnresonanz, das heißt sie stehen auf ihren jeweiligen
Orbitalbahnen in regelmäßigen Abständen relativ zu einander auf der selben Position \parencites[1]{Kleer_2024}[1]{Veenstra_2026}.
In dieser Laplace-Resonanz stehen die Umlaufzeiten von Io, Europa und Ganymed
in einem Verhältnis von 4:2:1 \parencite[1]{Veenstra_2026}.
Aus dieser Resonanz folgt eine exzentrische (=nicht ganz runde) Umlaufbahn des Ios, wodurch sich dieser
durch genannte Gezeitenkräfte aufheizt \parencites[1]{Kleer_2024}[1]{Veenstra_2026}.
...
\begin{center}
    \begin{figure}
        \includegraphics[width=\textwidth]{../Quellen/Bilder/Io.jpg}
        \caption{Aufnahme einer Gaswolke bei einem Vulkanausbruch auf dem Jupitermond Io. \citep{pic:Io}.}
        \label{pic:Io}
    \end{figure}
\end{center}
