...
\begin{center}
    \begin{figure}
        \includegraphics[width=5cm]{../Quellen/Bilder/Toothing_querschnitt.png}
        \includegraphics[width=5cm]{../Quellen/Bilder/Toothing.png}
        \caption{Topografisches Profil des Tooting-Krater, das durch den höchsten Punkt des Zentralbergs verläuft. Die vertikale Maßstabsverzerrung beträgt ×10. Entnommen aus \citep[1619]{Mouginis-Mark_2012}.}
        \label{P_Toothing}
    \end{figure}
\end{center}
