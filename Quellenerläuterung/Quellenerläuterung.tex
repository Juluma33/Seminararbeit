...
\author{}
\date{}
\title{{\fontsize{26pt}{30pt}\selectfont Seminarfach} \\[3cm] {\fontsize{30pt}{40pt}\selectfont Quellenerläuterung}}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}l
                                 >{\raggedright\arraybackslash}X}
        %--------------------------------------------------------------------------------------------------------------------
        \textbf{Zentralberge in Impaktkratern:}\\ \hline
