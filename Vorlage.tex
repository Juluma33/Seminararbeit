...
% "et al." bei mehr als zwei Autoren
\DefineBibliographyStrings{german}{andothers = {et\addabbrvspace al\adddot}}

% Doppelpunkt vor Seitenzahl (Jahr: S. 23)
\renewcommand*{\postnotedelim}{\addcolon\space}

% "S." vor Seitenzahlen
\DeclareFieldFormat{postnote}{S.~#1}

% Mehrere Quellen mit Semikolon
\renewcommand*{\multicitedelim}{\addsemicolon\space}

% "ebd." für Wiederholungen
\DefineBibliographyStrings{german}{ibid = {ebd\adddot}}
